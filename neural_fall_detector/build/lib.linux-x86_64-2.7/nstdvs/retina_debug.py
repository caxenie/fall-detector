...
class RetinaDebug(retina.Retina):
    def initialize(self):
        super(RetinaDebug, self).initialize()
        self.x = None
        self.y = None
        self.t = None
        self.p = None
    ...
    def process_retina(self, data):
        super(RetinaDebug, self).process_retina(data)
...
if __name__ == '__main__':
    ...
    thread.start_new_thread(brd1.data_loop, ())
    # thread.start_new_thread(brd2.data_loop, ())
