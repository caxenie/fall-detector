...
class Retina(nstdvs.NSTdvs):
    def initialize(self):
        super(Retina, self).initialize()
        self.retina(False)
    ...
    def connect(self, connection):
        super(Retina, self).connect(connection)
    ...
    def sensor_loop(self):
        """Handle all data coming from the board."""
        old_data = None
        buffered_ascii = ''
        while True:
